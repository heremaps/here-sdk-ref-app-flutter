...
class _ParentRegion extends Region {
  _ParentRegion.fromRegion(Region region)
      : super(region.regionId, region.internalparentId, region.name, region.sizeOnDiskInBytes,
            region.sizeOnNetworkInBytes, null);
}
